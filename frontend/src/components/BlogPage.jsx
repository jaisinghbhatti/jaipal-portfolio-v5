              ...
              <PortableText
                ...
                components={{
                  block: {
                    ...
                    h3: ({children}) => <h3 className="text-xl font-semibold mb-2 text-slate-700">{children}</h3>,
                  ...
                  list: {
                    bullet: ({children}) => <ul className="list-disc pl-6 mb-4 text-slate-600">{children}</ul>,
                    number: ({children}) => <ol className="list-decimal pl-6 mb-4 text-slate-600">{children}</ol>,
                  },
